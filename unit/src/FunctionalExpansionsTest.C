...
TEST(FunctionalExpansionsTest, legendreSeriesEvaluation)
{
  ...
  libMesh::Real location = -0.90922108754014;
  std::array<libMesh::Real, order> truth = { 0.50000000000000,
                                            -1.36383163131021,
                                             1.85006119760378,
                                            -1.80341832197563,
                                             1.19175581122701,
...
TEST(FunctionalExpansionsTest, solidCartesianLegendreEvaluation1D)
{
  ...
  std::vector<libMesh::Point> locations(number_of_locations);
  std::array<libMesh::Real, number_of_locations> truths;
  locations[0](0) =  -0.91053106631643;
  truths[0]       =  -0.09275380269767;
  locations[1](0) =   0.54546250195497;
  truths[1]       =   0.26395325750046;
  locations[2](0) =   0.87815200624901;
  truths[2]       =   0.51108336070264;
...
TEST(FunctionalExpansionsTest, solidCartesianLegendreEvaluation2D)
{
  ...
  std::vector<libMesh::Point> locations(number_of_locations);
  std::array<libMesh::Real, number_of_locations> truths;
  locations[0](0) =  -0.62565861438665;
  locations[0](1) =   0.35778939787196;
  truths[0]       =   0.60288980500110;
  locations[1](0) =  -0.76095070771917;
  locations[1](1) =  -0.44189666651278;
  truths[1]       =   0.48913478408852;
  locations[2](0) =  -0.37288682040427;
  locations[2](1) =   0.54937715621170;
  truths[2]       =   2.04511918092369;
...
TEST(FunctionalExpansionsTest, solidCartesianLegendreEvaluation3D)
{
  ...
  std::vector<libMesh::Point> locations(number_of_locations);
  std::array<libMesh::Real, number_of_locations> truths;
  locations[0](0) =  -0.14854612627465;
  locations[0](1) =   0.60364074055275;
  locations[0](2) =   0.76978431165674;
  truths[0]       =  -2.33043696271172;
  locations[1](0) =   0.93801805187856;
  locations[1](1) =   0.74175118177279;
  locations[1](2) =   0.74211345600994;
  truths[1]       =  74.48747654183712;
  locations[2](0) =   0.35423736896098;
  locations[2](1) =  -0.83921049062126;
  locations[2](2) =  -0.02231845586669;
  truths[2]       = -14.48091828923379;
...
TEST(FunctionalExpansionsTest, functionalExpansionInterface)
{
  ...
  const libMesh::Point location(-0.38541903411291,
                                 0.61369802505416,
                                -0.04539307255549);
  const libMesh::Real truth = 0.52843877055305;
  ...
  std::vector<libMesh::Real> newCoefficients(interface.getNumberOfCoefficients(), 2);
  ...
  interface.setCoefficients(std::vector<libMesh::Real>(interface.getNumberOfCoefficients(), 0));
